...
`hazelcast.index.copy.behavior` |COPY_ON_READ | string | Defines the behavior for index copying on index read/write. Please refer to the [Copying Indexes section](/Distributed_Query/How_Distributed_Query_Works/Indexing_Queries/).
