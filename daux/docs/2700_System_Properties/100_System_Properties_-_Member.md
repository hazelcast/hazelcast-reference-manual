...
`hazelcast.clientengine.query.thread.count`|core count * 1|int| Number of threads to process query requests coming from the clients. Default count is the number of cores multiplied by 1.
