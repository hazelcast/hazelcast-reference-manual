...
`javax.cache.processor.EntryProcessor`. For more general information, please see the [Implementing EntryProcessor section](../03_JCache_API/05_Implementing_Entry_Processor).
...
If we again take the `EntryProcessor` example from the demonstration application provided in the [Implementing EntryProcessor section](../03_JCache_API/05_Implementing_Entry_Processor),
