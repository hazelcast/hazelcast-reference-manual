...
For another example, you can tag some members with a filter so that a member in the cluster can load classes from those tagged members. Please see the [User Code Deployment section](/04_Setting_Up_Clusters/07_Member_User_Code_Deployment_-_BETA.md) for more information.
