...
![image](images/NoteSmall.jpg)***NOTE:*** *The version numbers used in the paragraph below are only used as an example.*
...
In the event of network partitions which split your cluster into two subclusters, split brain handling works as explained in the [Network Partitioning section](/24_Network_Partitioning), with the
