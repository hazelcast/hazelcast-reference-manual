...
<br></br>
![image](images/NoteSmall.jpg) ***NOTE:*** *Each partition can have multiple backups depending on your backup count. Please see the [Backing Up Maps section](#backing-up-maps).*
<br></br>
