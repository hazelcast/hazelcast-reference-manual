...
The 'mybenchmark' is the name of the outout directory. The generated report contains detailed throughput and latency information, and if dstats information is avialable, it will show detailed information about resource utilitization like network, cpu, memery etc.
