...
NOTE: You cannot use TLS/SSL when [Hazelcast Encryption](#encryption) is enabled.
...
In order to use secured communication between cluster and Management Center, you have to configure the cluster, see http://docs.hazelcast.org/docs/management-center/latest/manual/html-single/index.html#connecting-hazelcast-members-to-management-center[Connecting Hazelcast members to Management Center].
