=== Migrating Between IMDG 3.12 and 4.0/4.1 Releases Using the Migration tool
...
image::migration-scenario5.png[Migrating 3.12 -> 4.0/4.1 with Disaster Recovery sites]
