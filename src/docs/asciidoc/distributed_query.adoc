...
<<fast-aggregations, Fast-Aggregations>> and link:https://jet.hazelcast.org/[Hazelcast Jet^]
...
link:http://research.google.com/archive/mapreduce.html[research white paper^] on this
...
* link:http://research.google.com/archive/mapreduce.html[http://research.google.com/archive/mapreduce.html^]
* link:http://en.wikipedia.org/wiki/MapReduce[http://en.wikipedia.org/wiki/MapReduce^]
* link:http://hci.stanford.edu/courses/cs448g/a2/files/map_reduce_tutorial.pdf[http://hci.stanford.edu/courses/cs448g/a2/files/map_reduce_tutorial.pdf^]
* link:http://ksat.me/map-reduce-a-really-simple-introduction-kloudo/[http://ksat.me/map-reduce-a-really-simple-introduction-kloudo/^]
* link:http://www.slideshare.net/franebandov/an-introduction-to-mapreduce-6789635[http://www.slideshare.net/franebandov/an-introduction-to-mapreduce-6789635^]
...
The full example is available link:http://github.com/noctarius/hz-map-reduce[here^] as a ready to
run Maven project.
...
the link:https://docs.hazelcast.org/docs/latest/javadoc/com/hazelcast/mapreduce/Job.html[Job.java^] for more information.
