...
[source,xml]
----
<index type="BITMAP" unique-key="uniqueId" unique-key-transform="RAW">
    <attributes>
        <attribute>age</attribute>
    </attributes>
</index>
...
[source,xml]
----
<index type="BITMAP" unique-key="uniqueId" unique-key-transform="LONG">
    <attributes>
        <attribute>age</attribute>
    </attributes>
</index>
...
[source,xml]
----
<index type="BITMAP" unique-key="__key" unique-key-transform="OBJECT">
    <attributes>
        <attribute>age</attribute>
    </attributes>
</index>
...
[source,xml]
----
<index type="BITMAP" unique-key="<key>" unique-key-transform="<transform>">
    <attributes>
...
<index type="BITMAP" unique-key="__key.id">
    <attributes>
        <attribute>name.first</attribute>
    </attributes>
</index>
<index type="BITMAP" unique-key="id.external">
    <attributes>
        <attribute>name.first</attribute>
    </attributes>
</index>
...
to its link:{docBaseUrl}/javadoc/com/hazelcast/core/IMap.html#aggregate-com.hazelcast.aggregation.Aggregator-[Javadoc^]
...
link:{docBaseUrl}/javadoc/com/hazelcast/core/IMap.html#project-com.hazelcast.projection.Projection-[Javadoc^]
to see the method details.
