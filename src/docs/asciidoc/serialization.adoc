...
download them automatically, unless you are using <<member-user-code-deployment-beta, user code deployment>>.
...
(declare in the configuration file `hazelcast.xml`) as shown below.
...
in the client configuration, e.g., `hazelcast-client.xml`.
For the other Hazelcast clients, see the following for details:

* link:https://github.com/hazelcast/hazelcast-csharp-client#41-identifieddataserializable-serialization[.NET^]
* link:https://github.com/hazelcast/hazelcast-cpp-client#41-identifieddataserializable-serialization[C++^]
* link:https://github.com/hazelcast/hazelcast-nodejs-client#41-identifieddataserializable-serialization[Node.js^]
* link:https://github.com/hazelcast/hazelcast-python-client#41-identifieddataserializable-serialization[Python^]
* link:https://github.com/hazelcast/hazelcast-go-client#41-identifieddataserializable-serialization[Go^]
...
* link:https://github.com/hazelcast/hazelcast-csharp-client#42-portable-serialization[.NET^]
* link:https://github.com/hazelcast/hazelcast-cpp-client#42-portable-serialization[C++^]
* link:https://github.com/hazelcast/hazelcast-nodejs-client#42-portable-serialization[Node.js^]
* link:https://github.com/hazelcast/hazelcast-python-client#42-portable-serialization[Python^]
* link:https://github.com/hazelcast/hazelcast-go-client#42-portable-serialization[Go^]
...
You can declare Version in the configuration file `hazelcast.xml` using
...
link:{docBaseUrl}/javadoc/com/hazelcast/nio/serialization/VersionedPortable.html[VersionedPortable^]
...
the configuration file `hazelcast.xml`, as shown below.
