...
<hz:client id="client">
    ...
    <hz:network connection-attempt-period="3000"
...
transactions by using link:{docBaseUrl}/javadoc/com/hazelcast/spring/transaction/HazelcastTransactionManager.html[HazelcastTransactionManager^]
...
register link:{docBaseUrl}/javadoc/com/hazelcast/spring/transaction/ManagedTransactionalTaskContext.html[ManagedTransactionalTaskContext^]
