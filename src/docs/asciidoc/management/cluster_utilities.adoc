...
on your Unix-like local environments. You need link:https://www.oracle.com/java/technologies/javase-downloads.html[JRE 8 or newer^]
as a prerequisite.
...
Please see the tool's link:https://github.com/hazelcast/hazelcast-command-line[documentation^]
