...
See the https://github.com/hazelcast/hazelcast-code-samples/tree/master/clients/client-labels[code sample] for the client attributes to see them in action.
