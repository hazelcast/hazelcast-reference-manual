...
Here are the descriptions for the configuration elements:
...
To be able to use a Memcache client, you must enable the Memcache client request listener service using either of the following configuration options:
...
NOTE: Note that the usage of the `hazelcast.memcache.enabled` has been deprecated. Please use the either one of the above configuration to enable the Memcache client request listener service.
