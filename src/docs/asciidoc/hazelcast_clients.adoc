...
The client's behavior after this disconnection depends on its <<java-client-connection-strategy, `reconnect-mode`>>. Here are the options when you are using the blue-green mechanism (you have alternative clusters for your clients to connect):
