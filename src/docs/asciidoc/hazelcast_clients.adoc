...
See the <<configuring-client-connection-strategy, Configuring Client Connection Strategy section>>
to learn how to configure these.
...
See the Hazelcast Manager Center Reference Manual for information on blacklisting the clients.
