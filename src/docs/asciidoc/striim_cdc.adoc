...
We have created a link:https://github.com/hazelcast-guides/striim-hazelcast-cdc[full example application^] with step-by-step instructions which guides you through using Striim to load data from an Oracle database using the Striim Hazelcast Writer. We recommend yhou start here before applying this to your own application. 
