...
fails with a `SplitBrainProtectionException` (see <<split-brain-protection, Split-Brain Protection>>).
...
Here the configured map uses the `map-lock-actions-split-brain-protection` split brain protection for
map lock actions and the `map-actions-split-brain-protection` split brain protection for other map actions.
...
The following is a list of methods, grouped by the split brain protection type, that support Split-Brain Protection checks:
...
* `split-brain-protection-ref` : Name of split brain protection configuration that you want this queue to use.
...
* `split-brain-protection-ref`: Name of split brain protection configuration that you want this MultiMap to use.
...
The following is a list of methods that now support Split-Brain Protection checks. The list is grouped by
split brain protection type.
...
the method link:https://docs.hazelcast.org/docs/3.10/javadoc/com/hazelcast/config/MultiMapConfig.html[setSplitBrainProtectionName()^],
...
* `split-brain-protection-ref`: Name of split brain protection configuration that you want this Set to use.
...
The following is a list of methods, grouped by protection type, that support
...
the method link:https://docs.hazelcast.org/docs/3.10/javadoc/com/hazelcast/config/SetConfig.html[setSplitBrainProtectionName()^],
...
* `split-brain-protection-ref`: Name of split brain protection configuration that you want this List to use.
...
The following is a list of methods, grouped by protection type, that support Split-Brain Protection checks:
...
the method link:https://docs.hazelcast.org/docs/3.10/javadoc/com/hazelcast/config/ListConfig.html[setSplitBrainProtectionName()^],
or declaratively using the element `split-brain-protection-ref`. Following is an example declarative configuration:
...
The following is a list of methods, grouped by protection type, that support Split-Brain
Protection checks:
...
using the method link:https://docs.hazelcast.org/docs/3.10/javadoc/com/hazelcast/config/ReplicatedMapConfig.html[setSplitBrainProtectionName()^],
or declaratively using the element `split-brain-protection-ref`. Following is an example declarative configuration:
...
The value of `split-brain-protection-ref` should be the quorum configuration name which you
configured under the `split-brain-protection` element as explained in the <<split-brain-protection, Split-Brain Protection section>>.
...
programmatically using the method link:https://docs.hazelcast.org/docs/3.10/javadoc/com/hazelcast/config/CardinalityEstimatorConfig.html[setSplitBrainProtectionName()^],
