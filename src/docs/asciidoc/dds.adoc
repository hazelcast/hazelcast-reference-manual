...
When this element is set to `false`, the statistics will not be gathered for the map and cannot be seen on the Hazelcast Management Center, nor retrieved by the `getLocalMapStats()` method. 
...
* `statistics-enabled`: Specifies whether the statistics gathering will be enabled for your queue. If set to `false`, you cannot collect statistics in your implementation (using `getLocalQueueStats()`) and also https://docs.hazelcast.org/docs/management-center/latest/manual/html/index.html#monitoring-queues[Hazelcast Management Center] will not show them. Its default value is `true`.
...
* `statistics-enabled`: Specifies whether the statistics gathering will be enabled for your MultiMap. If set to `false`, you cannot collect statistics in your implementation (using `getLocalMultiMapStats()`) and also https://docs.hazelcast.org/docs/management-center/latest/manual/html/index.html#monitoring-multimaps[Hazelcast Management Center] will not show them. Its default value is `true`.
...
* `statistics-enabled`: Specifies whether the statistics gathering will be enabled for your topic. If set to `false`, you cannot collect statistics in your implementation (using `getLocalTopicStats()`) and also https://docs.hazelcast.org/docs/management-center/latest/manual/html/index.html#monitoring-topics[Hazelcast Management Center] will not show them. Its default value is `true`.
...
* `statistics-enabled`: Specifies whether the statistics gathering will be enabled for your Reliable Topic. If set to `false`, you cannot collect statistics in your implementation and also https://docs.hazelcast.org/docs/management-center/latest/manual/html/index.html#monitoring-reliable-topics[Hazelcast Management Center] will not show them. Its default value is `true`.
...
* `statistics-enabled`: Specifies whether the statistics gathering will be enabled for your PN Counter. If set to `false`, you cannot collect statistics in your implementation (using `getLocalPNCounterStats()`) and also https://docs.hazelcast.org/docs/management-center/latest/manual/html/index.html#monitoring-pn-counters[Hazelcast Management Center] will not show them. Its default value is `true`.
