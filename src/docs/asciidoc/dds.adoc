...
[source,java]
----
include::{javasource}/EvictAll.java[tag=evictall]
----
...
[source,java]
----
include::{javasource}/RacyUpdateMember.java[tag=racy]
----
...
[source,java]
----
include::{javasource}/PessimisticUpdateMember.java[tag=pum]
----
...
[source,java]
----
include::{javasource}/OptimisticMember.java[tag=om]
----
...
[source,java]
----
include::{javasource}/Employee.java[tag=emp]
----
...
[source,java]
----
include::{javasource}/ListenerWithPredicate.java[tag=lwp]
----
...
[source,java]
----
include::{javasource}/Modify.java[tag=modify]
----
