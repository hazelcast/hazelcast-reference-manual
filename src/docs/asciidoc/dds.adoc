...
The following is a sample code snippet for a publisher:
...
The following is a sample code snippet for a subscriber:
...
it has a limited capacity; you may want to change that configuration. The following is an example configuration for the "sometopic" given above.
...
Please see the <<configuring-reliable-topic, Configuring Reliable Topic section>> below.
