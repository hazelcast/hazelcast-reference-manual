...
[source,java]
----
include::{javasource}/map/EvictAll.java[tag=evictall]
----
...
[source,java]
----
include::{javasource}/map/RacyUpdateMember.java[tag=racy]
----
...
[source,java]
----
include::{javasource}/map/PessimisticUpdateMember.java[tag=pum]
----
...
[source,java]
----
include::{javasource}/map/OptimisticMember.java[tag=om]
----
...
[source,java]
----
include::{javasource}/map/Employee.java[tag=emp]
----
...
[source,java]
----
include::{javasource}/map/ListenerWithPredicate.java[tag=lwp]
----
...
[source,java]
----
include::{javasource}/map/Modify.java[tag=modify]
----
...
[source,java]
----
include::{javasource}/queue/SampleQueue.java[tag=samplequeue]
----
...
[source,java]
----
include::{javasource}/queue/ProducerMember.java[tag=producer]
----
...
[source,java]
----
include::{javasource}/queue/ConsumerMember.java[tag=consumer]
----
...
[source,java]
----
include::{javasource}/queue/QueueConfiguration.java[tag=queueconf]
----
...
[source,java]
----
include::{javasource}/multimap/SampleMultiMap.java[tag=mm]
----
...
[source,java]
----
include::{javasource}/multimap/PrintMember.java[tag=pm]
----
...
[source,java]
----
include::{javasource}/multimap/MultiMapConfiguration.java[tag=mmc]
----
...
[source,java]
----
include::{javasource}/set/SampleSet.java[tag=set]
----
...
[source,java]
----
include::{javasource}/set/SetConfiguration.java[tag=sc]
----
...
[source,java]
----
include::{javasource}/list/SampleList.java[tag=list]
----
...
[source,java]
----
include::{javasource}/list/ListConfiguration.java[tag=lc]
----
...
[source,java]
----
include::{javasource}/ringbuffer/SampleRB.java[tag=rb]
----
...
[source,java]
----
include::{javasource}/ringbuffer/Writer.java[tag=writer]
----
...
[source,java]
----
include::{javasource}/ringbuffer/RBConfiguration.java[tag=rbc]
----
...
[source,java]
----
include::{javasource}/topic/TopicStats.java[tag=ts]
----
...
[source,java]
----
include::{javasource}/topic/TopicConfiguration.java[tag=tc]
----
