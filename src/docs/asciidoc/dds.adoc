...
these structures are usable from Java, .NET, C++, Node.js, Python, Go and Scala.
...
link:https://docs.hazelcast.org/docs/4.0-BETA-2/javadoc/com/hazelcast/config/IndexConfig.html[IndexConfig^]
...
the method link:https://docs.hazelcast.org/docs/4.0-BETA-2/javadoc/com/hazelcast/config/MultiMapConfig.html[setSplitBrainProtectionName()^],
...
the method link:https://docs.hazelcast.org/docs/4.0-BETA-2/javadoc/com/hazelcast/config/SetConfig.html[setSplitBrainProtectionName()^],
...
the method link:https://docs.hazelcast.org/docs/4.0-BETA-2/javadoc/com/hazelcast/config/ListConfig.html[setSplitBrainProtectionName()^],
or declaratively using the element `split-brain-protection-ref`. Following is an example declarative configuration:
...
using the method link:https://docs.hazelcast.org/docs/4.0-BETA-2/javadoc/com/hazelcast/config/ReplicatedMapConfig.html[setSplitBrainProtectionName()^],
or declaratively using the element `split-brain-protection-ref`. Following is an example declarative configuration:
...
programmatically using the method link:https://docs.hazelcast.org/docs/4.0-BETA-2/javadoc/com/hazelcast/config/CardinalityEstimatorConfig.html[setSplitBrainProtectionName()^],
...
link:https://docs.hazelcast.org/docs/4.0-BETA-2/javadoc/com/hazelcast/config/CardinalityEstimatorConfig.html[setMergePolicyConfig()^],
