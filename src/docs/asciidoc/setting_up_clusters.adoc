...
For example, assuming you have `hazelcast-all` on your classpath and your runtime is Kubernetes, Hazelcast
automatically applies the <<kubernetes-cloud-discovery, Kubernetes discovery mechanism>>.
