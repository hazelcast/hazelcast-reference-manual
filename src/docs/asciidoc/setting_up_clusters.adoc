...
Starting with 3.8.2, there is no need for a group password on the member side. And, starting with 3.11, there is no need for a group password on the client side either.
