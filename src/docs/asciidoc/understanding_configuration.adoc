...
In both cases, the entry structure needs to reflect Hazelcast YAML configuration representation.

Keep in mind that it's not possible to represent configuration entries represented as YAML sequences.
