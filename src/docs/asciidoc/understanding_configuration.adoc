...
When overriding configuration provided in a custom file, remember to overwrite whole config sections at once (if you don't, remaining entries will be set to defaults).


NOTE: The above mechanism exists mostly for the sake of convenience of applying trivial
