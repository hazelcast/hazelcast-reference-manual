...
The "Difference count" column shows the number of the entries different in the source and target clusters.
This is the minimum number of entries that need to be synchronized to make the clusters consistent. The "Entries synced"
