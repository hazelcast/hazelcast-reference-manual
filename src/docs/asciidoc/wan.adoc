...
=== WAN Synchronization Using Merkle Trees
...
NOTE: Currently, Merkle tree structure is implemented only for Hazelcast maps. It will also be implemented for caches in the future releases.
