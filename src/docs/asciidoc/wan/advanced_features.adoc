...
See the <<diagnostics, Diagnostics section>> to learn how to enable
...
persisted to a database for example, otherwise it is not persisted. Default value is `false`.
