...
to get you started. You may want to configure some additional aspects of your maps or caches that use WAN replication; see the <<configuring-wan-replication-for-imap-and-icache, Configuring for IMap and ICache section>> for information on this.
