...
See the https://docs.hazelcast.org/docs/jet/latest-dev/manual/index.html#work-with-jet[Work with Jet] section in the Hazelcast Jet Reference Manual to see a simple example.
