...
NOTE: You can also use the start scripts to deploy your own code to a Hazelcast member from a non-Java client. See the <<using-code-deployment-for-non-java-clients, Using Code Deployment for Non-Java Clients section>>.
