...
`hazelcast-<version>.jar` file into your
...
* `com.hazelcast.core` for `hazelcast-<version>.jar` and
`hazelcast-enterprise-<version>.jar`
* `com.hazelcast.client` for `hazelcast-client-<version>.jar`
and `hazelcast-enterprise-client-<version>.jar`

Don't use `hazelcast-all-<version>.jar` or
`hazelcast-enterprise-all-<version>.jar` on the modulepath as it could
