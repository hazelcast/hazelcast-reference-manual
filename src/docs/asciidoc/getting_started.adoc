...
NOTE: You can also use the start scripts to deploy your own library to a Hazelcast member from a non-Java client. See the <<adding-user-library-to-classpath, Adding User Library to CLASSPATH section>>.
