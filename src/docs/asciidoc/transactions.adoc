...
link:{docBaseUrl}/javadoc/com/hazelcast/transaction/TransactionContext.html[here^].
...
link:{docBaseUrl}/javadoc/com/hazelcast/transaction/HazelcastXAResource.html[here^].
