...
due to size-based eviction. See the <<map-eviction, Map Eviction section>> for more information. 
...
for example using IMap's `remove()` method or the REST `DELETE` <<removing-entries-from-a-map-for-rest-client, call>>.
...
* link:https://github.com/hazelcast/hazelcast-csharp-client#75-distributed-events[.NET client^]
* link:https://github.com/hazelcast/hazelcast-cpp-client#75-distributed-events[C++ client^]
* link:https://github.com/hazelcast/hazelcast-nodejs-client/blob/master/DOCUMENTATION.md#75-distributed-events[Node.js client^]
* link:https://github.com/hazelcast/hazelcast-go-client#75-distributed-events[Go client^]
* link:https://github.com/hazelcast/hazelcast-python-client#75-distributed-events[Python client^]
