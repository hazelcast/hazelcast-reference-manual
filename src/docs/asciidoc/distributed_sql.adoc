...
Distributed SQL allows you to access data stored in the Hazelcast cluster
declaratively using SQL.

=== Beta Status

The distributed SQL is currently in beta. The compatibility between versions
...
Only `IMap` objects are supported at the moment.
