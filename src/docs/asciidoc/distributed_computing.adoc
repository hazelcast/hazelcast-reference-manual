...
NOTE: Hazelcast integrates the https://docs.spring.io/spring/docs/current/spring-framework-reference/integration.html#scheduling-task-scheduler[task scheduling] feature of Spring with IScheduledExecutorService. You can use Hazelcast's IScheduledExecutorService within Spring context for your task scheduling needs.  See <<using-task-scheduling, Using Task Scheduling with IScheduledExecutorService section>> for more information.
