...
To be able to benefit from the Health Check endpoint and script, you must enable the Health Check using either of the following configuration options:
...
NOTE: Note that the usage of the `hazelcast.http.healthcheck.enabled` has been deprecated. Please use the either one of the above configuration to enable the Health Check utility.
...
First, you need to enable the health check as explained in the introduction of the <<health-check-and-monitoring
