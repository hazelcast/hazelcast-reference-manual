...
The scripting can be allowed or forbidden by specifying `scripting-enabled` attribute in Management center configuration within Hazelcast member configuration file:
