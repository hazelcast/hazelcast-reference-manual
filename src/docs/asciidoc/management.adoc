...
See the link:{docBaseUrl}/javadoc/com/hazelcast/monitor/LocalMapStats.html[`LocalMapStats` Javadoc^] to see all the metrics.
...
See the link:{docBaseUrl}/javadoc/com/hazelcast/monitor/LocalIndexStats.html[`LocalIndexStats` Javadoc^] to see all the metrics.
...
See the link:{docBaseUrl}/javadoc/com/hazelcast/monitor/NearCacheStats.html[`NearCacheStats` Javadoc^] to see all the metrics.
...
See the link:{docBaseUrl}/javadoc/com/hazelcast/monitor/LocalMultiMapStats.html[`LocalMultiMapStats` Javadoc^] to see all the metrics.
...
See the link:{docBaseUrl}/javadoc/com/hazelcast/monitor/LocalQueueStats.html[`LocalQueueStats` Javadoc^] to see all the metrics.
...
See the link:{docBaseUrl}/javadoc/com/hazelcast/monitor/LocalTopicStats.html[`LocalTopicStats` Javadoc^] to see all the metrics.
...
See the link:{docBaseUrl}/javadoc/com/hazelcast/monitor/LocalExecutorStats.html[`LocalExecutorStats` Javadoc^] to see all the metrics.
...
link:{docBaseUrl}/javadoc/com/hazelcast/core/Cluster.html[Cluster interface^] to change your cluster's state.
...
feature. See the link:{docBaseUrl}/javadoc/com/hazelcast/core/Cluster.html#shutdown--[Cluster Shutdown API^]
for more info.
* **`IN_TRANSITION`**:
...
See the link:{docBaseUrl}/javadoc/com/hazelcast/core/Cluster.html[Cluster interface Javadoc^] for information on these methods.
