...
* `getConnectionTimeout()` -> clientConfig.getNetworkConfig().getConnectionTimeout();`
* `setConnectionTimeout(int)` -> clientConfig.getNetworkConfig().setConnectionTimeout(int);`
* `addAddress(String)` -> clientConfig.getNetworkConfig().addAddress(String);`
* `getAddresses()` -> clientConfig.getNetworkConfig().getAddresses();`
* `setAddresses(List)` -> clientConfig.getNetworkConfig().setAddresses(List);`
* `isRedoOperation() -> clientConfig.getNetworkConfig().isRedoOperation();`
* `setRedoOperation(boolean) -> clientConfig.getNetworkConfig().setRedoOperation(boolean);`
* `getSocketOptions() -> clientConfig.getNetworkConfig().getSocketOptions();`
* `setSocketOptions() -> clientConfig.getNetworkConfig().setSocketOptions(SocketOptions);`
* `setSocketOptions() -> clientConfig.getNetworkConfig().setSocketOptions(SocketOptions);`
* `getNetworkConfig().setAwsConfig(new ClientAwsConfig()); -> clientConfig.getNetworkConfig().setAwsConfig(new AwsConfig());
