...
OpenSSL:
If SSL is used and OpenSSL capabilities are detected and the Java version is less than 11 and no explicit SSLEngineFactory
is configured, Hazelcast will default to OpenSSL.