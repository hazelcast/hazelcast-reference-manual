...
all attributes and nested elements were removed from programmatic, XML and YAML configurations
...
This came with the following changes of the system properties that configure Management Center.
