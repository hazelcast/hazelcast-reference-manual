...
The following methods of link:https://docs.hazelcast.org/docs/4.0-BETA-2/javadoc/com/hazelcast/client/config/ClientConfig.html[ClientConfig^] have been refactored:
...
Also the `ClientAwsConfig` class has been renamed as link:https://docs.hazelcast.org/docs/4.0-BETA-2/javadoc/com/hazelcast/config/AwsConfig.html[AwsConfig^].

The naming for the declarative configuration elements have not been changed.
See the link:https://docs.hazelcast.org/docs/rn/#4-0-beta-1[Release Notes^] for
...
* link:https://docs.hazelcast.org/docs/4.0-BETA-2/javadoc/com/hazelcast/query/extractor/ValueCallback.html[ValueCallback^]
* link:https://docs.hazelcast.org/docs/4.0-BETA-2/javadoc/com/hazelcast/query/extractor/ValueExtractor.html[ValueExtractor^]
...
See the link:https://docs.hazelcast.org/docs/4.0-BETA-2/javadoc/com/hazelcast/partition/MigrationListener.html[MigrationListener^] Javadoc
for a full insight.
...
See the following table for the before/after sample link:https://docs.hazelcast.org/docs/4.0-BETA-2/javadoc/com/hazelcast/security/IPermissionPolicy.html[IPermissionPolicy^] implementations.
...
The `getId()` method of the link:https://docs.hazelcast.org/docs/4.0-BETA-2/javadoc/com/hazelcast/nio/serialization/IdentifiedDataSerializable.html[IdentifiedDataSerializable^] interface
...
of link:https://docs.hazelcast.org/docs/4.0-BETA-2/javadoc/com/hazelcast/map/EntryProcessor.html[EntryProcessor^] which now defines how the entries will be processed
...
The link:https://docs.hazelcast.org/docs/4.0-BETA-2/javadoc/com/hazelcast/projection/Projection.html[Projection^] class was an abstract interface for historical reasons.
...
See the link:https://docs.hazelcast.org/docs/4.0-BETA-2/javadoc/com/hazelcast/config/ServiceConfig.html[here^]
...
See the link:https://docs.hazelcast.org/docs/4.0-BETA-2/javadoc/com/hazelcast/core/HazelcastInstance.html[here^]
...
See the link:https://docs.hazelcast.org/docs/4.0-BETA-2/javadoc/com/hazelcast/core/DistributedObjectEvent.html[here^]
