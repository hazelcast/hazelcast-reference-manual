...
This appendix provides guidelines when upgrading to a new Hazelcast IMDG version. See also the https://docs.hazelcast.org/docs/rn/[release notes] documents for any changes to the features.
