...
The following are example queue configurations including the `QueueStore` configuration which is explained in the [Queueing with Persistent Datastore](#queueing-with-persistent-datastore) section.
